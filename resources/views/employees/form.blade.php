<div class="">
  ...
  <div class="row">
    ...
    <x-form.input
      ...
      name="birth_place"
      :value="old('birth_place', $form->birth_place ?? '')" />
    <x-religion-dropdown :value="old('religion', $form->religion ?? '')" />
    <x-marital-status-dropdown
      :value="old('marital_status', $form->marital_status ?? '')" />
    <x-form.input
      type="text"
      label="Nationality"
      name="nationality"
  ...
  <div class="row">
    ...
    <x-employee-department-dropdown
      :value="old('department_id', $form->department_id ?? '')" />
    <x-employee-position-dropdown
      :value="old('employee_position_id', $form->employee_position_id ?? '')" />
    <x-employee-level-dropdown
      :value="old('employee_level_id', $form->employee_level_id ?? '')" />
    <x-employee-shift-dropdown
      :value="old('employee_shift_id', $form->employee_shift_id ?? '')" />
    <x-head-department-employee-dropdown
      label="Manager"
      :value="$form->head_departmen_id ?? ''" />
  </div>
  ...
  <div class="row">
    ...
    <x-form.switch
      label="Document is Unlimited"
      name="document_is_unlimited"
      :value="$form->document_is_unlimited ?? 0" />

    <x-form.input
      type="text"
      label="BPJS Number"
      name="document_bpjs_no"
      :value="$form->document_bpjs_no ?? ''" />
    <x-form.input
      type="text"
      label="BPJS Name"
      name="document_bpjs_name"
      :value="$form->document_bpjs_name ?? ''" />
    <x-form.file
      label="Document File BPJS"
      name="document_bpjs_file"
      folder="document_bpjs_file"
      :value="$form->document_bpjs_file ?? ''" />

    <x-form.input
      type="text"
      label="BPJS-TK Number"
      name="document_bpjstk_no"
      :value="$form->document_bpjstk_no ?? ''" />
    <x-form.input
      type="text"
      label="BPJS-TK Name"
      name="document_bpjstk_name"
      :value="$form->document_bpjstk_name ?? ''" />
    <x-form.file
      label="Document File BPJS-TK"
      name="document_bpjstk_file"
      folder="document_bpjstk_file"
    ...
    <x-form.input
      type="text"
      label="Tax Registered Name"
      name="tax_registered_name"
      :value="$form->tax_registered_name ?? ''" />
  </div>
  ...
  <div class="row">
    <x-form.switch
      ...
      name="is_attendance_location"
      :value="old('is_attendance_location', $form->is_attendance_location ?? '')" />
  </div>
