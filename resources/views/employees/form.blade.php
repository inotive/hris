<div class="">
    ...
    <div class="row">
        ...
        <x-form.input type="text" :label="__('Username')" name="username"
    ...
    <hr>
    <div class="row">
        <x-form.input type="text" :label="__('First Name')" name="first_name"
                      :value="old('first_name', $form->first_name ?? '')"/>
        <x-form.input type="text" :label="__('Last Name')" name="last_name"
                      :value="old('last_name', $form->last_name ?? '')"/>
        <x-gender-dropdown :value="old('gender', $form->gender ?? '')"/>
        <x-form.datepicker :label="__('Birth Date')" name="birth_date"
                           :value="old('birth_date', $form->birth_date ?? '')"/>
        <x-form.input type="text" :label="__('Birth Place')" name="birth_place"
        ...
        <x-form.image-picker :label="__('Image')" name="image" folder="employees"
    ...
    <div class="row">
        ...
        <x-form.file label="Document File" name="document_file" folder="document_file"
                     :value="$form->document_file ?? ''"/>
        <x-form.switch label="Document is Unlimited" name="document_is_unlimited"
        ...
        <x-form.input type="text" label="BPJS-TK Number" name="document_bpjstk_no"
                      :value="$form->document_bpjstk_no ?? ''"/>
        <x-form.input type="text" label="BPJS-TK Name" name="document_bpjstk_name"
        ...
        <x-form.input type="text" label="Tax Registered Name" name="tax_registered_name"
