    ...
    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
      <div class="d-flex flex-column">
        <div class="d-flex align-items-center mb-2">
          <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $employee->first_name ?? '' }}
        ...
        <div class="d-flex flex-wrap">
          <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
            <div class="fs-2 fw-bolder counted" data-kt-countup-value="123">
              {{ number_format($employee->leave_request_count ?? 0, 0, ',', '.') }}
            </div>
            <div class="fw-bold fs-8 text-gray-400">Total Leave</div>
          </div>
          <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
            <div class="fs-2 fw-bolder counted" data-kt-countup-value="123">
              {{ number_format($employee->overtime_request_count ?? 0, 0, ',', '.') }}
            </div>
            <div class="fw-bold fs-8 text-gray-400">Total Overtime</div>
          </div>
          <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
            <div class="fs-2 fw-bolder counted" data-kt-countup-value="123">
              {{ number_format($employee->reimbursement_request_count ?? 0, 0, ',', '.') }}
            </div>
