<div class="d-flex flex-wrap flex-sm-nowrap">
  <div class="me-7 mb-4">
    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
      <img src="{{ Storage::url($company->logo ?? '') }}" alt="image" onerror="this.onerror=null; this.src='{{
    ...
    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
      <div class="d-flex flex-column">
        <div class="d-flex align-items-center mb-2">
          <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $company->name ?? '' }}</a>
          <a href="#">
    ...
    <div class="d-flex flex-wrap align-items-center">
      ...
      <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
        ...
        <div class="h-5px mx-3 w-100 bg-light mb-3">
          <div class="{{ $company->day_left_percent_subscription() >= 40 ? 'bg-success' : 'bg-warning' }} rounded h-5px"
            role="progressbar" style="width: {{ $company->day_left_percent_subscription() }}%" aria-valuemin="0"
