<div class="row">
    ...
    <x-form.input :required="true" type="text" :label="__('Company Name')" name="company_name" :value="old('company_name', $form->company_name ?? '')" />
    <x-form.input :required="true" type="text" :label="__('Company Location')" name="company_location" :value="old('company_location', $form->company_location ?? '')" />
    <x-form.input :required="true" type="text" :label="__('Line of Business')" name="line_of_business" :value="old('line_of_business', $form->line_of_business ?? '')" />
    <x-form.input :required="true" type="text" :label="__('Position Held')" name="position_held" :value="old('position_held', $form->position_held ?? '')" />
    <x-form.textarea :required="true" :label="__('Job Description')" name="job_description" :value="old('job_description', $form->job_description ?? '')" />
    ...
    <x-currency-dropdown :required="true" label="Initial Currency" name="initial_currency" :value="old('initial_currency', $form->initial_currency ?? '')" />


    <x-form.currency :required="true" :label="__('Initial Salary')" name="initial_sallary" :value="old('initial_sallary', $form->initial_sallary ?? '')" />
    ...
    <x-form.input type="text" :label="__('Reference Position')" name="reference_position" :value="old('reference_position', $form->reference_position ?? '')" />
