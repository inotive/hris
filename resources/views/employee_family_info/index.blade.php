<x-table.index>
  ...
  <x-slot name="toolbar">
    <x-table.add-button
      :label="__('Add Family Info')"
      :href="route('family-info.create', $employee->id)" />
  </x-slot>
        ...
        <x-slot name="body">
          ...
          <tr>
            ...
            <td class="text-end">
              <x-table.actions>
                <x-table.edit-button
                  :href="route('family-info.edit', [$employee, $value->id])" />
                <x-table.delete-button
                  :href="route('family-info.destroy', [$employee, $value->id])" />
              </x-table.actions>
            </td>
          </tr>
          @endforeach
