@extends('layouts.app') @section('page_title') @if (isset($page_title))
{{ __($page_title) }}
@else @yield('page_title') @endif @stop @section('content')
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-12 col-lg-6 gap-2 d-flex mb-5 justify-content-end">
              ...
              {{-- GENERATE DUMMY --}}
              <x-table.generate-dummy-button
                show_dummy_button="{{ $show_dummy_button ?? false }}" />
              {{-- ADD BUTTON --}}
              <x-table.add-button
                :href="$add_button_href ?? null"
