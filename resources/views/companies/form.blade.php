<div class="row">
    ...
    <x-form.select :list="['backward' => 'Backward', 'current' => 'Current']" label="Cut Off Payroll Method" name="cut_off_payroll_method" :value="old('cut_off_payroll_method', $form->cut_off_payroll_method ?? '')"   :required="true"/>
