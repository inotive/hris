<div class="row">
    ...
    <x-form.select required label="Master Type" name="master_type" :list="\App\Models\EmployeePayslipMaster::master_type_dropdown()" :value="old('master_type', $form->master_type ?? '')" />
