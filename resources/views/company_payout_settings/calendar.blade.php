                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 mb-10">
                    <div class="card">
                        <div class="card-body p-3">
                            <div id="inline-datepicker-{{ $key }}" class="text-center"
                                data-date="{{ $value->date }}"></div>

                            <input type="hidden" class="form-control" id="payouts_{{ $key }}"
                                name="payouts[{{ \Carbon\Carbon::parse($value->date)->format('m') }}]"
                                value="{{ $value->date }}" />
                        </div>
                    </div>
                </div>
